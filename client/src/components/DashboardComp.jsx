      ...
      <div className="flex flex-wrap gap-4">
        <div className="flex flex-col p-3 dark:bg-slate-700 gap-4 md:w-72 w-full rounded-md shadow-md">
          ...
          <div className="flex gap-2 text-sm">
            ...
            <div className="text-gray-500">Last Month User's</div>
          </div>
        </div>
        <div className="flex flex-col p-3 dark:bg-slate-700 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
                    ...
                    <Table.Body key={user._id} className='divide-y'>
                        ...
                        Π dark:bg-gray-800'>
                            <Table.Cell>
                                ...
                                alt='user'
                                className='w-10 h-10 rounded-full Ibg-gray-500'
                                />
                                </Table.Cell>
            ...
            <Table>
                ...
                {comments &&
                    ...
                    <Table.Body key={comment._id} className='divide-y'>
                        <Table.Row className='bg-white dark: border-gray-700
                        Π dark:bg-gray-800'>
                                <Table.Cell className="w-80"><p className="line-clamp-2">{comment.content}</p></Table.Cell>
                ...
                {posts &&
                    ...
                    <Table.Body key={post._id} className='divide-y'>
                        ...
                        Π dark:bg-gray-800'>
                            ...
                            <Table.Cell className="line-clamp-2">{post.title}</Table.Cell>
